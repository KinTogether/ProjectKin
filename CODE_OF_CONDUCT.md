...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers via a private channel (see [SECURITY.md](SECURITY.md) for the contact). All complaints will be reviewed and investigated promptly and fairly.
